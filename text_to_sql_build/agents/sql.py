from text_to_sql_build.services.sql_generator import llm_generate_sql, llm_plan_sql, llm_review_sql
from text_to_sql_build.llm.models import DeepSeek

def generate_sql_from_agents(question, schema, reviewer=False, model=DeepSeek):
